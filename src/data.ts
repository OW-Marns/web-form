...
export const initialChecklistState: ChecklistSection = {
  listing: [
    {
      category: "Appraisals",
    ...
    },
    {
      ...
      comments: "",
      helperText:
        "IF YES, ABILITY TO ATTACH THE CMA REPORT. IF NO, CANNOT PROCEED RED FLAG - REQUIRES A COMMENTS FIELD FOR FURTHER EXPLAINATION; ABILITY TO ATTACH A FILE WILL ALSO BE REQUIRED.",
    },
    {
      category: "Appraisals",
    ...
    },
    {
      ...
      reviewer: "",
      comments: "",
      helperText: "IF NO, REG FLAG NEEDS TO ACTIONED AND THEN REVERTS TO YES.",
    },
    {
      category: "Sales Authority",
    ...
    },
    {
      ...
      reviewer: "",
      comments: "",
      helperText: "IF NO, RED FLAG - COMMENTS FIELD REQUIRED TO BE FILED OUT.",
    },
    {
      category:
...
export const initialSignOffState: SignOff = {
  listing: {
    agentName: "",
    agentDate: "",
    reviewerName: "",
